"""speaker-classify-lychee skill 的 smoke 测试。"""
import pytest
...
@pytest.fixture
def skill_name():
    return "speaker-classify-lychee"
...
def test_skill_md_has_yaml_frontmatter(skill_dir):
    assert_skill_frontmatter(skill_dir, "speaker-classify-lychee")


def test_script_help_runs(skill_dir):
    assert_script_help(skill_dir, "classify.py", ["--file"])
